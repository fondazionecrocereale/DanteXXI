...
class _$AuthResponseImpl implements _AuthResponse {
  ...
  @override
  String toString() {
    return 'AuthResponse(user: $user, token: $token, refreshToken: $refreshToken, message: $message)';
  }
  ...
  int get hashCode => Object.hash(runtimeType,
      const DeepCollectionEquality().hash(_user), token, refreshToken, message);
...
class _$ErrorResponseImpl implements _ErrorResponse {
  const _$ErrorResponseImpl(
      {required this.error, this.message, this.statusCode});
